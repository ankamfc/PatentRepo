...
public class SearchToFilesMapReduce {
	...
	public static void main(String[] args) throws Exception {
		...
		String index = "C:/Users/Suraj/workspace/Indexes/indexToTestClaims";
	...
	public void doPagingSearch(BufferedReader in, IndexSearcher searcher,
		...
		for (int i = start; i < end; i++) {
			 ...
			 * doc.get("claimText") };
			 */
			if (doc.get("Description") != null || doc.get("claimText") != null) {
				File file = new File("C:/Users/Suraj/workspace/Files/" + i
						+ ".txt");
