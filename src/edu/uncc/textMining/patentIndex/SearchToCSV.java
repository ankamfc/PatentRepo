...
public class SearchToCSV {
	...
	public static void main(String[] args) throws Exception {
		...
		String index = "indexToTestClaims";
		String field = "Title";
		String queries = null;
		int repeat = 0;
		boolean raw = false;
	...
	public void doPagingSearch(BufferedReader in, IndexSearcher searcher,
		...
		for (int i = start; i < end; i++) {
			if (i == start) {
				patentList.add(new String[]{"PatentId","DatePublished", "Assignee","Title", "City", "State","AbstractText","Description","usClaimStatement","claimText"});
			}
			...
			String searchString[] = { doc.get("PatentId"),
					...
					doc.get("AbstractText"),doc.get("Description") ,doc.get("usClaimStatement"),doc.get("claimText")};
